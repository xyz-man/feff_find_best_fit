...
class Configuration:
    ...
    EXPERIMENTAL_SPECTRUM_X_SHIFT = EXPERIMENTAL_SPECTRUM_X_SHIFT
    EXPERIMENTAL_SPECTRUM_Y_SHIFT = EXPERIMENTAL_SPECTRUM_Y_SHIFT
    EXPERIMENTAL_SPECTRUM_Y_SCALE = EXPERIMENTAL_SPECTRUM_Y_SCALE
